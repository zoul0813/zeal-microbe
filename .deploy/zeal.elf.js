...
var ASM_CONSTS = {
  255299: () => { if (document.fullscreenElement) return 1; },  
 255345: () => { return Module.canvas.width; },  
 255377: () => { return parseInt(Module.canvas.style.width); },  
 255425: () => { document.exitFullscreen(); },  
 255452: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 255525: () => { if (document.fullscreenElement) return 1; },  
 255571: () => { return Module.canvas.width; },  
 255603: () => { return screen.width; },  
 255628: () => { document.exitFullscreen(); },  
 255655: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 255788: () => { return window.innerWidth; },  
 255814: () => { return window.innerHeight; },  
 255841: () => { if (document.fullscreenElement) return 1; },  
 255887: () => { return Module.canvas.width; },  
 255919: () => { return parseInt(Module.canvas.style.width); },  
 255967: () => { if (document.fullscreenElement) return 1; },  
 256013: () => { return Module.canvas.width; },  
 256045: () => { return screen.width; },  
 256070: () => { return window.innerWidth; },  
 256096: () => { return window.innerHeight; },  
 256123: () => { if (document.fullscreenElement) return 1; },  
 256169: () => { return Module.canvas.width; },  
 256201: () => { return screen.width; },  
 256226: () => { document.exitFullscreen(); },  
 256253: () => { if (document.fullscreenElement) return 1; },  
 256299: () => { return Module.canvas.width; },  
 256331: () => { return parseInt(Module.canvas.style.width); },  
 256379: () => { document.exitFullscreen(); },  
 256406: ($0) => { Module.canvas.style.opacity = $0; },  
 256444: () => { return screen.width; },  
 256469: () => { return screen.height; },  
 256495: () => { return window.screenX; },  
 256522: () => { return window.screenY; },  
 256549: () => { return window.devicePixelRatio; },  
 256585: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 256638: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 256689: () => { Module.canvas.style.cursor = 'none'; },  
 256726: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 256982: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 257033: () => { if (document.fullscreenElement) return 1; },  
 257079: () => { return window.innerWidth; },  
 257105: () => { return window.innerHeight; },  
 257132: () => { if (document.pointerLockElement) return 1; },  
 257179: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 259357: () => { if (typeof(window.miniaudio) !== 'undefined') { miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 259647: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 259751: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 259922: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 262799: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 262872: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 263272: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 263322: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 263461: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; }
};
function hostfs_web_enabled() { return Module.hostfsBackend ? 1 : 0; }
function hostfs_web_start(operation,path,flags,descriptor,offset,guest_address,length,write_data) { const request = { operation, path: path ? UTF8ToString(path) : null, flags, descriptor, offset: offset >>> 0, guestAddress: guest_address, length, data: write_data ? HEAPU8.slice(write_data, write_data + length) : null, }; Module.hostfsBackend.start(request); }
...
var _hostfs_web_complete = Module['_hostfs_web_complete'] = makeInvalidEarlyAccess('_hostfs_web_complete');
var _hostfs_web_write_guest = Module['_hostfs_web_write_guest'] = makeInvalidEarlyAccess('_hostfs_web_write_guest');
var _malloc = Module['_malloc'] = makeInvalidEarlyAccess('_malloc');
var _zeal_exit_web = Module['_zeal_exit_web'] = makeInvalidEarlyAccess('_zeal_exit_web');
var _zeal_exit = Module['_zeal_exit'] = makeInvalidEarlyAccess('_zeal_exit');
var _zeal_debug_toggle_web = Module['_zeal_debug_toggle_web'] = makeInvalidEarlyAccess('_zeal_debug_toggle_web');
var _zeal_snes_button_web = Module['_zeal_snes_button_web'] = makeInvalidEarlyAccess('_zeal_snes_button_web');
var _zeal_snes_clear_web = Module['_zeal_snes_clear_web'] = makeInvalidEarlyAccess('_zeal_snes_clear_web');
...
var _show_fps = Module['_show_fps'] = makeInvalidEarlyAccess('_show_fps');
var wasmMemory = makeInvalidEarlyAccess('wasmMemory');

function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['strerror'] != 'undefined', 'missing Wasm export: strerror');
  assert(typeof wasmExports['free'] != 'undefined', 'missing Wasm export: free');
  assert(typeof wasmExports['hostfs_web_complete'] != 'undefined', 'missing Wasm export: hostfs_web_complete');
  assert(typeof wasmExports['hostfs_web_write_guest'] != 'undefined', 'missing Wasm export: hostfs_web_write_guest');
  assert(typeof wasmExports['malloc'] != 'undefined', 'missing Wasm export: malloc');
  assert(typeof wasmExports['zeal_exit_web'] != 'undefined', 'missing Wasm export: zeal_exit_web');
  assert(typeof wasmExports['zeal_exit'] != 'undefined', 'missing Wasm export: zeal_exit');
  assert(typeof wasmExports['zeal_debug_toggle_web'] != 'undefined', 'missing Wasm export: zeal_debug_toggle_web');
  assert(typeof wasmExports['zeal_snes_button_web'] != 'undefined', 'missing Wasm export: zeal_snes_button_web');
  assert(typeof wasmExports['zeal_snes_clear_web'] != 'undefined', 'missing Wasm export: zeal_snes_clear_web');
  ...
  assert(typeof wasmExports['show_fps'] != 'undefined', 'missing Wasm export: show_fps');
  _strerror = createExportWrapper('strerror', 1);
  _free = Module['_free'] = createExportWrapper('free', 1);
  _hostfs_web_complete = Module['_hostfs_web_complete'] = createExportWrapper('hostfs_web_complete', 7);
  _hostfs_web_write_guest = Module['_hostfs_web_write_guest'] = createExportWrapper('hostfs_web_write_guest', 3);
  _malloc = Module['_malloc'] = createExportWrapper('malloc', 1);
  _zeal_exit_web = Module['_zeal_exit_web'] = createExportWrapper('zeal_exit_web', 0);
  _zeal_exit = Module['_zeal_exit'] = createExportWrapper('zeal_exit', 1);
  _zeal_debug_toggle_web = Module['_zeal_debug_toggle_web'] = createExportWrapper('zeal_debug_toggle_web', 0);
  _zeal_snes_button_web = Module['_zeal_snes_button_web'] = createExportWrapper('zeal_snes_button_web', 2);
  _zeal_snes_clear_web = Module['_zeal_snes_clear_web'] = createExportWrapper('zeal_snes_clear_web', 0);
  ...
  _show_fps = Module['_show_fps'] = wasmExports['show_fps'].value;
}
