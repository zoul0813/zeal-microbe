...
function(zeal_use)
    foreach(libname IN LISTS ARGV)
        ...
        if(NOT sdk_path)
            message(FATAL_ERROR "Cannot find environment variable for library '${libname}' (tried ${env_candidates})")
        endif()

        # Add include and lib directories
        target_include_directories(microbe PUBLIC "${sdk_path}/include")
        target_link_directories(microbe PRIVATE "${sdk_path}/lib")

        # Link the library
        target_link_libraries(microbe PUBLIC ${libname})
    endforeach()
endfunction()
